#ifndef WINDOW_GUARD      // ezzel elllenőrizzük le hogy ez a header be van e includolva -e a programunkba 
#define WINDOW_GUARD 1    // igyel arra hogy ne lehssen 2x be includolni egy header filet | Linkelési hibát tud okozni ha ezt tesszük ézert kell ez "define"
...
public: 
	...
	int x_max() const { return w; }  // helper fv
	int y_max() const { return h; }  // u.a
